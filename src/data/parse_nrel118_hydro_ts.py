...
def parse_nrel118_hydro_ts(
    raw_data: str, path_parsed_data: Optional[str] = None
) -> Optional[pd.DataFrame]:
    """Parse time-series data about hydro plants from the NREL-118 dataset.
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        raise ValueError(
            ...
            "parse_nrel118_hydro_ts.py path_raw_data path_parsed_data\n"
        )

    # Run
    parse_nrel118_hydro_ts(raw_data=sys.argv[1], path_parsed_data=sys.argv[2])
